...
test_dir = 'Strawberry_milk_model_image/test'
...
train_datagen =  ImageDataGenerator(
  ...
  rotation_range=90, # 角度值，0~180，影象旋轉
...
model.save('Strawberry_milk_model_250.h5')
...
plt.ylabel('accuracy')
plt.legend()
plt.savefig('acc_Strawberry_milk_model_250.png')
plt.show()
...
plt.ylabel('loss')
plt.legend()
plt.savefig('loss_Strawberry_milk_model_250.png')
